...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"kvmctl-pp-cli auth login",
		"kvmctl-pp-cli doctor",
		"kvmctl-pp-cli help items",
		"kvmctl-pp-cli sync",
		"kvmctl-pp-cli profile list",
		"kvmctl-pp-cli feedback list",
		"kvmctl-pp-cli which",
		"kvmctl-pp-cli agent-context",
		"kvmctl-pp-cli completion bash",
		"kvmctl-pp-cli version",
	}
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"kvmctl-pp-cli teach",
		"kvmctl-pp-cli recall",
		"kvmctl-pp-cli learnings",
		"kvmctl-pp-cli teach-pattern",
		"kvmctl-pp-cli teach-lookup",
		"kvmctl-pp-cli items list",
	}

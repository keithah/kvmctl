...
func TestDeclaredAPISurfaceReachable(t *testing.T) {
	expected := []string{
		...
		"hid reset",
		"hid send-key",
		"hid send-mouse-button",
		"hid send-mouse-move",
		"hid send-mouse-wheel",
		"hid send-shortcut",
		"info",
		"kvmd-compatible-kvm-auth",
		"kvmd-compatible-kvm-auth check",
		"kvmd-compatible-kvm-auth login",
		"kvmd-compatible-kvm-auth logout",
		"streamer",
		"streamer get-snapshot",
		"streamer set-params",
		"system",
	}

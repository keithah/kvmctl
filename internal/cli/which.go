...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  kvmctl-pp-cli which "stale tickets"
  kvmctl-pp-cli which "bottleneck"
  kvmctl-pp-cli which --limit 1 "send message"
  kvmctl-pp-cli which                                # list the full capability index`,
